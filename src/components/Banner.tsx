...
export default function Banner() {
    return (
      <div className="flex flex-col border border-sky-500 w-screen h-screen">
        <Navbar />
...
Lorem, ipsum dolor.*/}
Discover a world of trendy fashion and effortless shopping, where style meets convenience and every purchase brings you closer to your best look.
          </p>
          <button className="bg-white border border-logo-blue text-logo-blue font-extrabold self-start px-8 py-4 mt-5 text-xl rounded-full shadow-button hover:shadow-button-hover">
            Shop Now!
          </button>
          </div>
        <div className="flex-1 flex justify-start items-center bg-center bg-cover p-0">

          <img src={four} alt="image" className=""/>
        </div>
